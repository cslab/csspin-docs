...
The csspin-docs repository is hosted on a private GitLab instance, while the
repository itself is mirrored to [GitHub](https://github.com/cslab/csspin-docs)
...
Please follow the guidelines below when contributing to the csspin-docs project.
...
repository](https://github.com/cslab/csspin-docs/issues) for reporting issues
...
3. `git clone <your-fork-or-repo-url> csspin-docs && cd csspin-docs && pre-commit install`
...
> This section is only relevant for maintainers of the csspin-docs project.

The version scheme used is major.minor.patch following semver.org.

Releases are created by csspin-docs maintainers within the GitLab instance
...
1. Create the release notes by opening a new merge request at the csspin-docs
